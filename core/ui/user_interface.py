...
image_column = [
    [
        sg.Image(filename='core/ui/static/plus.png', size=(80, 80), enable_events=True, key='__ICON__'),
    ]
]
...
def popup_select(elements):
    layout_popup = [
        ...
        [
            ...
            sg.Button(button_text='Download', button_color='blue', key='__DOWNLOAD_AUDIO__', pad=((0, 132), (10, 10))),
    ...
    layout_popup[0].append(
        sg.Listbox(
                    elements, key='_AUDIO_', size=(45, len(elements)), highlight_background_color='green',
                    highlight_text_color='white', select_mode='extended', bind_return_key=True
        )
    )
    window_popup = sg.Window('Choose audio name', layout=layout_popup, font=font)
